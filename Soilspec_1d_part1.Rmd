...
```{r}
spc_1d_pca<-preProcess(spectra_1d,
...
```{r}
matplot(as.numeric(colnames(spectra_1d)),spc_1d_pca$std, type = "l", col = "blue")

matplot(as.numeric(colnames(spectra_1d)),spc_1d_pca$mean, type = "l", col = "red")
```
### Loadings
```{r}
matplot(as.numeric(colnames(spectra_1d)),spc_1d_pca$rotation[,1], type = "l", col = "blue")
```
### Plotting projections
```{r}
matplot(seq(1,5,by=1),t(PC_scores_1d[,1:5]),pch=1, col = "blue",
