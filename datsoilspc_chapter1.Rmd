...
## Mapas de scores
Una vez obtenida la matriz de scores T la podemos representar con diferentes mapas de scores, representando los ejes X e Y a los términos elegidos oara la visualización:
```{r}
